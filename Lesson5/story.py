...
dungeon = {
 ...
 'room2' : {
    ...
    'choices_no_enemies' : [
         { 'route_key' : 'explore_room2', 'text': 'Search the room?' } ,
         { 'route_key' : 'west_corridor_from_room2', 'text': 'Take the West corridor on the other side of the room?' } ,
     ],
    'choices_if_enemies' : [
 ...
 'west_corridor_from_room2' : {
     'type' : 'room',
     'visited' : 'no',
     'desc' : "The corridor goes 50' to the West then is blocked by rubbles.\
                 \nAnother dark path goes to the north from here.",
     'desc_visited' : "You are in the far west corridor",
     'choices_no_enemies' : [
         { 'route_key' : 'corridor_to_room5', 'text' : 'Take the north corridor?' } ,
         { 'route_key' : 'turn_around_room2', 'text' : 'Go back to the rust monster room?' },
     ],
     'choices_if_enemies' : [],
     'enemies' : [],
     'next_step' : 'choices',
     'next_room' : '', },
  'turn_around_room2' : { #### TODO To add path to the other room
        'type' : 'action',
        'desc' : "[TODO - NOT CODED YET] - You go back to the rust monster room ",
        'next_step' : 'move',
        'next_room' : 'room2',
    },
  'corridor_to_room5' : { #### TODO To add path to the other room
        'type' : 'action',
        'desc' : "[TODO - NOT CODED YET] - You go back to the rust monster room ",
        'next_step' : 'move',
        'next_room' : 'room2',
 ...
 #Rats Room and Actions in the East corridor
    ...
    'room3' : { #The rats room
        ...
        'choices_no_enemies' : [
             { 'route_key' : 'go_to_room1_from_room3', 'text' : 'Go back to the first room?'  } ,
             { 'route_key' : 'take_corridor_from_room3', 'text' : 'Take one of the corridor on the opposite side of the room?'  },
             { 'route_key' : 'search_room3', 'text' : 'Search the room?' }
        ],
        'choices_if_enemies': [], #entering combat automatically, no choices
    ...
    'search_room3' : { #### TODO add finding some stuff in the room
        'type' : 'action',
        'desc' : "[TODO - NOT CODED YET] - You search the room ",
        'next_step' : 'move',
        'next_room' : 'room3',
    },
#Goblin Room and Actions in the North corridor
    ...
    'room4' : { #Goblin room
        ...
        'choices_no_enemies' : [
             { 'route_key' : 'go_to_room1_from_room4', 'text' : 'Turn around and go back to the first room?'  } ,
             { 'route_key' : 'search_room4', 'text' : 'Search the room?'  } ,
         ],
         'choices_if_enemies': [
             { 'route_key' : 'go_to_room1_from_room4', 'text' : 'Turn around and go back to the first room quietly?'  } ,
         ...
         'enemies' : [ 'goblin', 'goblin', 'goblin', 'goblin_captain' ],
         'next_step' : 'choices',
         'next_room' : '',
    },
    'take_north_corridor_from_room4' : { #### TODO To add path to the other room
        'type' : 'action',
    ...
    'take_east_corridor_from_room4' : { #### TODO To add path to the other room
        'type' : 'action',
        'desc' : "[TODO - NOT CODED YET] - You go back to the first room ",
        'next_step' : 'move',
        'next_room' : 'room4',
    ...
    'search_room4' : { ### To add path to the other room
        'type' : 'action',
        'desc' : "[TODO - NOT CODED YET] - You search the room ",
        'next_step' : 'move',
        'next_room' : 'room4',
    ...
    'death' : {
        'type' : 'room',
        'visited' : 'no',
        'desc' : "Your have not been able to survive this dungeon but hopefully you\
